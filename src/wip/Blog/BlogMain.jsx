...
const Card = ({ children }) => (
  <div className="bg-teal-800 shadow-sparkle rounded-lg overflow-hidden relative z-10 h-full w-full">
    {children}
  </div>
);
  ...
  const BlogSection = ({ title, description, items }) => (
    <section className="relative z-10 py-8">
      <div className="flex flex-col md:flex-row justify-between items-center mb-6">
        <h2 className="text-2xl mb-4 md:mb-0 cursor-pointer hover:underline text-green-300 tracking-wide font-bold">{title}</h2>
      </div>
