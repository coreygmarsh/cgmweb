...
const SectionTwo = () => {
  ...
  return (
    <div className="flex items-center justify-center mx-6 xl:mx-24 lg:mx-24 md:mx-12 sm:mx-6 shadow-sparkle h:[30vh] xl:h-[100vh] bg-gradient-to-l from-cyan-900 to-slate-800" 
    style={{
