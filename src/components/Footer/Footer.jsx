...
const Footer = () => {
  return (
    <footer className="text-center px-6 md:px-12 lg:px-36 text-neutral-600 dark:bg-slate-950 py-10 dark:text-neutral-200">
      <div className="flex items-center justify-center py-6 border-b border-neutral-200 dark:border-neutral-500 lg:justify-between">
      ...
      <div className="mx-6 md:mx-12 lg:mx-36 py-10 text-center md:text-left">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="font-customnine tracking-wide text-md md:text-lg lg:text-xl">
              About Me
          ...
          <div>
            ...
            <p className="mb-4 flex items-center font-customnine text-md md:text-lg lg:text-xl justify-center md:justify-start">
      ...
      <div className="bg-cyan-500 p-6 text-center font-customnine dark:bg-slate-950">
