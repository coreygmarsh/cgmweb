...
import { BlackSea, CausLightning, CausticLightning, Caustics, Danita, GreenLightning, LetMeLoose, LyricVideos, ProductDemos, WaveEyes, WavesThree, watertexture } from '../../images/ImgAssets';
...
const content = [
  { title: "Product Demos", description: "Product Demo Videos", content: <div>Detailed content for section 1</div>, image: ProductDemos, link: "/demo" },
  { title: "Lyric Videos", description: "Lyric Videos", content: <div>Detailed content for section 2</div>, image: LyricVideos, link: "/lyric" },
...
const Library = () => {
  ...
  return (
    <div className='relative min-h-screen bg-gradient-to-b from-teal-800 via-cyan-600 to-slate-900'>
      {/* <div
        className="absolute top-0 left-0 w-full h-full bg-center  opacity-60"
